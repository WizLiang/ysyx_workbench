...
VL_ATTR_COLD void Vcpu_top::trace(VerilatedFstC* tfp, int levels, int options) {
    if (tfp->isOpen()) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vcpu_top::trace()' shall not be called after 'VerilatedFstC::open()'.");
    }
