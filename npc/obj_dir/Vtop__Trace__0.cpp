...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+0,(vlSelf->top__DOT__overflow));
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgBit(oldp+9,(vlSelf->top__DOT__key_pressed));
        bufp->chgCData(oldp+10,(vlSelf->top__DOT__key_count),8);
        bufp->chgCData(oldp+11,(vlSelf->top__DOT__ascii),8);
        bufp->chgCData(oldp+12,(vlSelf->top__DOT__u_keyboard_processor__DOT__key_buffer),8);
        bufp->chgBit(oldp+13,(vlSelf->top__DOT__u_keyboard_processor__DOT__read_state));
