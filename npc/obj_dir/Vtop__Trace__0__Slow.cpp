...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBit(c+10,"key_pressed",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+11,"key_count",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 7,0);
    tracep->declBus(c+12,"ascii",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 7,0);
    tracep->declBit(c+1,"overflow",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1);
    ...
    tracep->declBit(c+10,"key_pressed",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+11,"key_count",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 7,0);
    tracep->declBus(c+13,"key_buffer",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 7,0);
    tracep->declBit(c+14,"read_state",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    ...
    tracep->declBus(c+12,"ascii",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 7,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_seven_seg_decoder0 ");
    tracep->declBus(c+15,"digit",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 3,0);
    tracep->declBit(c+10,"enable",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+10,(vlSelf->top__DOT__key_pressed));
    bufp->fullCData(oldp+11,(vlSelf->top__DOT__key_count),8);
    bufp->fullCData(oldp+12,(vlSelf->top__DOT__ascii),8);
    bufp->fullCData(oldp+13,(vlSelf->top__DOT__u_keyboard_processor__DOT__key_buffer),8);
    bufp->fullBit(oldp+14,(vlSelf->top__DOT__u_keyboard_processor__DOT__read_state));
