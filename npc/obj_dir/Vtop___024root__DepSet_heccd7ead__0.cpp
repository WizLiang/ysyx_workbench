...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        ...
        vlSelf->top__DOT__u_ps2_keyboard__DOT__overflow = 0U;
        vlSelf->__Vdly__top__DOT__ready = 0U;
    }
    vlSelf->top__DOT__u_ps2_keyboard__DOT__ps2_clk_sync 
        = __Vdly__top__DOT__u_ps2_keyboard__DOT__ps2_clk_sync;
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    CData/*0:0*/ __Vdly__top__DOT__u_keyboard_processor__DOT__key_pressed;
    __Vdly__top__DOT__u_keyboard_processor__DOT__key_pressed = 0;
    // Body
    __Vdly__top__DOT__u_keyboard_processor__DOT__key_pressed 
        = vlSelf->top__DOT__u_keyboard_processor__DOT__key_pressed;
    ...
    if (vlSelf->rst_n) {
        if (((IData)(vlSelf->top__DOT__ready) & (~ (IData)(vlSelf->top__DOT__u_keyboard_processor__DOT__read_state)))) {
            ...
            if ((0xf0U == (IData)(vlSelf->top__DOT__u_keyboard_processor__DOT__key_buffer))) {
                __Vdly__top__DOT__u_keyboard_processor__DOT__key_pressed = 0U;
            } else if ((1U & (~ (IData)(vlSelf->top__DOT__u_keyboard_processor__DOT__key_pressed)))) {
                vlSelf->top__DOT__key_count = (0xffU 
                                               & ((IData)(1U) 
                                                  + (IData)(vlSelf->top__DOT__key_count)));
                __Vdly__top__DOT__u_keyboard_processor__DOT__key_pressed = 1U;
            }
        } else {
    ...
    __Vtableidx6 = ((0x1eU & ((IData)(vlSelf->top__DOT__last_key) 
                              >> 3U)) | (IData)(vlSelf->top__DOT__key_valid));
    ...
    __Vtableidx7 = ((0x1eU & ((IData)(vlSelf->top__DOT__last_key) 
                              << 1U)) | (IData)(vlSelf->top__DOT__key_valid));
    vlSelf->top__DOT____Vcellout__u_seven_seg_decoder0__segments 
        = Vtop__ConstPool__TABLE_h99acd3d6_0[__Vtableidx7];
    vlSelf->seg5 = ((IData)(vlSelf->top__DOT____Vcellout__u_seven_seg_decoder5__segments) 
                    << 1U);
    vlSelf->seg4 = ((IData)(vlSelf->top__DOT____Vcellout__u_seven_seg_decoder4__segments) 
                    << 1U);
    ...
    vlSelf->seg1 = ((IData)(vlSelf->top__DOT____Vcellout__u_seven_seg_decoder1__segments) 
                    << 1U);
    vlSelf->seg0 = ((IData)(vlSelf->top__DOT____Vcellout__u_seven_seg_decoder0__segments) 
                    << 1U);
    vlSelf->seg3 = ((IData)(vlSelf->top__DOT____Vcellout__u_seven_seg_decoder3__segments) 
                    << 1U);
    vlSelf->seg2 = ((IData)(vlSelf->top__DOT____Vcellout__u_seven_seg_decoder2__segments) 
                    << 1U);
}
