...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    __Vtableidx2 = 0;
    // Body
    __Vtableidx1 = vlSelf->data_in;
    vlSelf->top__DOT__u_digit = Vtop__ConstPool__TABLE_h4bcc976c_0
        [__Vtableidx1];
    vlSelf->top__DOT____Vcellout__u_encoder_83__valid 
        = Vtop__ConstPool__TABLE_h5de07d9b_0[__Vtableidx1];
    vlSelf->led = ((0xfffeU & (IData)(vlSelf->led)) 
                   | (IData)(vlSelf->top__DOT____Vcellout__u_encoder_83__valid));
    __Vtableidx2 = vlSelf->top__DOT__u_digit;
    vlSelf->top__DOT____Vcellout__u_seven_seg_decoder__segments 
        = Vtop__ConstPool__TABLE_h25bdbd99_0[__Vtableidx2];
    vlSelf->seg0 = ((IData)(vlSelf->top__DOT____Vcellout__u_seven_seg_decoder__segments) 
                    << 1U);
}
